...
desc state_list;
select * from state_list where id=12;
select id,state,city_name from state_list join all_cities on state_list.id=all_cities.state_code where id=12;

select city_name from state_list join all_cities on state_list.id=all_cities.state_code where id=12;

select id,state from state_list;
